...
@Table("adwords_weekly_ad_network_account_performance")
public class WeeklyAdNetworkPerformanceBean {

	private String client_customer_id;
	@PrimaryKeyColumn(name = "ad_network_type1", ordinal = 0, type = PrimaryKeyType.CLUSTERED)
	@Column
	...
	public WeeklyAdNetworkPerformanceBean() {
