...
@Table("adwords_monthly_ad_network_account_performance")
public class MonthlyAdNetworkPerformanceBean {
	...
	@PrimaryKeyColumn(name = "ad_network_type1", ordinal = 1, type = PrimaryKeyType.CLUSTERED)
	@Column
	...
	public MonthlyAdNetworkPerformanceBean() {
